    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h2 className="text-lg font-semibold mb-4">Supabase 配置</h2>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <h3 className="font-semibold text-blue-900 mb-2">需要配置的环境变量</h3>
            <p className="text-blue-800 text-sm">
              请确保在项目根目录的 <code>.env.local</code> 文件中包含以下配置：
            </p>
            <pre className="mt-2 text-xs bg-blue-100 p-3 rounded overflow-x-auto">
