          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent 
                  align="end" 
                  className="w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-1"
                  sideOffset={8}
                >
                  {/* User Info Section */}
              ...
              {user ? (
                <>
                  <div className="px-3 py-2">
                    <Link 
                      href="/profile" 
                      className="flex items-center space-x-2 px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium"
                      onClick={() => setIsOpen(false)}
                    >
                      <User size={16} />
