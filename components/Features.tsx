      ...
      <div className="max-w-6xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {translations.features.features.map((feature, index) => (
            ...
            >
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 sm:mb-4 text-center sm:text-left">
                  <div className="flex flex-col sm:flex-row sm:items-center mb-2 sm:mb-4 sm:mb-0">
                    <div className={cn(
                      "text-2xl sm:text-3xl mx-auto sm:mr-4 sm:ml-0 transition-all duration-300",
                      activeFeature === index && "scale-110"
                    )}>
                      {feature.icon}
                    </div>
                    <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 dark:text-white mt-2 sm:mt-0">
                      {feature.title}
                    </h3>
                  </div>
                  {activeFeature === index && (
                    <div className="flex justify-center sm:justify-end space-x-2">
                      <Button
                        size="sm"
                        variant="outline"
                        className="w-6 h-6 sm:w-8 sm:h-8 p-0 border-gray-300 dark:border-gray-600 hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                        onClick={(e) => {
                          e.stopPropagation();
                          setIsAnimating(true);
                ...
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-relaxed mb-3 sm:mb-4">
                  {feature.description}
                </p>
                
                {activeFeature === index && (
                  <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/50 dark:to-purple-900/50 rounded-lg border border-blue-200 dark:border-blue-700">
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-4 sm:p-6 lg:p-8 text-white">
            ...
            <button 
              className="bg-white text-blue-600 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 text-xs sm:text-sm lg:text-base w-full sm:w-auto max-w-xs sm:max-w-none"
              style={{ 
                maxWidth: '20rem',
                overflow: 'hidden',
            ...
            >
              <span className="truncate text-center block w-full">{translations.features.cta.button}</span>
            </button>
          </div>
        </div>
      </div>
